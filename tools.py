...
def getData(s):
    url = "http://ups.youku.com/ups/get.json?vid=" + s + "&ccode=0401&client_ip=192.168.1.2&utid=ot8EEZHbomYCAXBXbJb10GiE&client_ts=1501143009"
    ...
    try:
        ...
        print("Url: %s" % url)
        return
    url = "http://service.danmu.youku.com/pool/info?iid="+ str(iid) + "&ct=1001&cid=97&ouid=62583473&lid=0&aid=319177"
    r = requests.get(url, cookies = _cook, headers = _headers).json()
    data['count'] = r['count']
    return data
